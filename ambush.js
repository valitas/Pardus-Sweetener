...
PSWAmbushScreenDriver.prototype = {
  updateValueMessageHandler: function(msg) {
  ...
  setupQLsUI: function(aqls_enabled, aqls, mtime, pql_enabled, pql) {
  ...
  addQL: function(container, qlname, ql) {
    var input = this.doc.createElement('input');
    input.type = 'button';
