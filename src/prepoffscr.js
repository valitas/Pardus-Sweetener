...
//
// Like, before sending a message to the offscreen page, we want to make sure
// that the page is around to receive it, and some dancing around is needed to
// do that properly. The Chrome offscreen API is weirdly complicated.
