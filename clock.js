...
APTimer.prototype.createNode = function(doc, label, title) {
...
function NPCTimer(doc) {
  this.createNode(doc, 'N', 'Time to next roaming NPC move (not Z series, Lucidi)');
}
...
VClock.prototype.setEnabled = function(which, enabled) {
  var changed;
